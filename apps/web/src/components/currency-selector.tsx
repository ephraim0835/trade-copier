  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button 
        ...
        className="plaiz-plaiz-pill plaiz-pill-neutral hover:bg-black/5 dark:hover:bg-white/5 pr-2 pl-3 group"
      >
      ...
      {isOpen && (
        <div className="absolute right-0 top-full mt-2 w-32 plaiz-card rounded-xl py-1 z-50 animate-in fade-in zoom-in-95 duration-200">
          <button
            onClick={() => {
              setCurrency('USD');
              setIsOpen(false);
