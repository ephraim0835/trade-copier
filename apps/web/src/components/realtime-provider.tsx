...
export function RealtimeProvider({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      {!isConnected && (
        <div className="fixed bottom-4 right-4 bg-amber-500/10 text-amber-500 border border-amber-500/20 px-3 py-1.5 rounded-full text-xs font-medium flex items-center gap-2 z-50">
